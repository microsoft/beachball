...
| `--registry` | `-r` | as configured for npm | npm registry for fetching package versions (required if you've explicitly [configured authentication](../concepts/ci-integration#npm-authentication)) |
