...
```
yarn plugin import https://raw.githubusercontent.com/microsoft/beachball/yarn-plugin-engines_v0.3.1/yarn-plugins/engines/dist/plugin.js
```

If you'd like a non-minified version for debugging:

```
yarn plugin import https://raw.githubusercontent.com/microsoft/beachball/yarn-plugin-engines_v0.3.1/yarn-plugins/engines/dist/plugin.dev.js
```
