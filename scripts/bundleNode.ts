...
// .mjs extensions are unnecessary for actions since they're handled directly by github.
...
/** additional permissive licenses not currently included in cloudpack's check */
const extraLicenses: Array<string | null> = ['BlueOak-1.0.0'];
