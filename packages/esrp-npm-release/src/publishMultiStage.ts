...
// The original code (closer to this file) has a lot of extra logic for multi-stage builds and
// manually downloading artifacts. Keeping the refactored version for reference, but this probably
// not necessary for the npm scenario where a single artifact has been generated upfront and
// already downloaded by a previous task.
