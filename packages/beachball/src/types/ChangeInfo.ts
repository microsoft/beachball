...
export interface ChangeFileInfo {
  ...
  packageName: string;
  /** Author email (may be unset if change file was generated by beachball v3) */
  email: string;
  /** How to bump packages that depend on this one (may be unset if change file was generated by beachball v3) */
